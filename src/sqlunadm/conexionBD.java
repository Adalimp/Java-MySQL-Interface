...
public class conexionBD 
{
       ...
       public static  void hola()
       {
          ...
          try
          {
              ...
              Connection conexion2 = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3307/RegistrosKinderRosita","root","PerroT3ZZZ*123"); 
       ...
       public static void registrardatos(String idalumno,String nombre,String edad,String papa,String mama,String telefono,String grado,String grupo)
       {
        ...
        try
        {
            ...
            conexionrd= DriverManager.getConnection("jdbc:mysql://127.0.0.1:3307/RegistrosKinderRosita","root","PerroT3ZZZ*123");
